...
def main():
    ...
    parser.add_argument("--xnnpack", action="store_true", help="Use XNNPACK backend for acceleration")
    ...
    et = lower_to_executorch(programs, args.output_dir, use_xnnpack=args.xnnpack)
